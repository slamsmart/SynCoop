...
export default function Membership() {
  ...
  return (
    <div data-testid="membership-page">
      <PageHeader kicker="Kartu Anggota Koperasi" title="Kartu Anggota"
        desc="Anggota baru menunggu 365 hari sebelum jadi Anggota Penuh. Setelah itu, lengkapi data diri (KTP & HP) untuk diperiksa koperasi." />
